...
namespace OnlineTraining.API.Helpers.Extensions
{
    public static class ServicesCollectionExtension
    {
        ...
        public static IServiceCollection InjectServicesCollection(this IServiceCollection services)
        {
            ...
            services.AddSingleton<ICourseDetailRepository, CourseDetailRepository>();
            services.AddScoped<ICourseDetailServices, CourseDetailServices>();

            services.AddSingleton<IBookmarkRepository, BookmarkRepository>();
            services.AddScoped<IBookmarkServices, BookmarkServices>();

            services.AddSingleton<ICourseMediaRepository, CourseMediaRepository>();
            services.AddScoped<ICourseMediaServices, CourseMediaServices>();
